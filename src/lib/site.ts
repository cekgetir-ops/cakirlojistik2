...
export const site = {
  ...
  legalName: "sehirlerarasiaractasima.com",
  // Başlıkta ismin altında duruyor; kısa olmak zorunda.
  tagline: "Kaskolu Araç Nakliyesi",
  description:
    "1997'den beri şehirler arası çoklu araç taşıma, yol yardım ve otopark hizmeti. Kaskolu taşıma, yazılı teslim tarihi, tüm Türkiye'ye hizmet.",
  founded: 1997,
  founder: "Murat Çakır",
  /** Kanonik adres — metadataBase ve canonical etiketleri buradan üretilir */
  url: "https://sehirlerarasiaractasima.com",
} as const;

export const nav = [
  { label: "Ana Sayfa", href: "/" },
  { label: "Hizmetler", href: "/hizmetler" },
  { label: "Hizmet Bölgelerimiz", href: "/hizmet-bolgelerimiz" },
...
export const hours = [
  { day: "Hafta içi", time: "08:00 ile 20:00" },
  { day: "Cumartesi", time: "09:00 ile 18:00" },
  { day: "Pazar", time: "10:00 ile 16:00" },
] as const;
