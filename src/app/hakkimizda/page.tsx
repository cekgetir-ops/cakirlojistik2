...
export const metadata: Metadata = {
  title: "Hakkımızda",
  description:
    "Çakır Lojistik 1997 yılında Murat Çakır tarafından kuruldu. İstanbul–Ankara hattında çoklu araç taşıma, yol yardım ve otopark hizmeti veriyoruz.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Çakır Lojistik, İstanbul–Ankara hattında çoklu araç taşıma, yol yardım ve otopark hizmeti veren bir aile şirketi."
      />
