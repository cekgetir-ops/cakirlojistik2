...
export default function Home() {
  return (
    <>
      ...
      {/* Scroll'a bağlı dört sahnelik anlatım: bölüm ekranda sabitlenir,
          kaydırma ilerledikçe 300 karelik dizi ve sahne metinleri akar */}
      <StoryTelling />
        ...
        <div className="shell py-20 lg:py-28">
          ...
          <Reveal delay={120}>
            ...
            <div className="route-card mt-16 rounded-2xl border border-line bg-surface p-8 lg:p-12">
              ...
              {/* Hat İstanbul Ankara'yı anlatıyor; bu satır kapsamın orayla
                  sınırlı olmadığını sessizce söylüyor. Rozet, ölçüler
                  şeridinin üstünde tek başına duruyor ki dikkat dağıtmasın. */}
              <p className="route-scope mt-8 inline-flex items-center gap-2.5 rounded-full border border-line bg-canvas-alt px-3.5 py-1.5 text-[13px] text-ink-soft">
                <span
                  aria-hidden="true"
                  className="route-scope-dot size-1.5 shrink-0 rounded-full bg-accent"
                />
                Tüm Türkiye&apos;ye hizmet verilmektedir.
              </p>
      ...
      <section className="shell mt-32 lg:mt-40">
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <Reveal delay={120} className="lg:sticky lg:top-28 lg:self-start">
            <Figure
              ratio="4 / 5"
              alt="Ekibimiz aracı taşıyıcıya yüklerken"
